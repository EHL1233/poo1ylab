...
public class App {
    public static void main(String[] args) {
        ...
        CuentaBancaria cuenta1 = new CuentaBancaria(90000);
        ...
        Cliente cliente1 = new Cliente("Shinji Ikari", cuenta1);
        System.out.println("Cliente 1 : " + cliente1);
        Cliente cliente2 = new Cliente("EL Bicho", new CuentaBancaria(89777));
        ...
        Cliente cliente3 = new Cliente("Mizato Katsuragi", new CuentaBancaria(2000));
