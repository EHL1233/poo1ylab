...
public class _p62_SecuenciaNumeros2 {
    public static void main(String[] args) {
        ...
        System.out.println("Imprimir la secuencia de números mostrados el número de renglones que el usuario desee.\n");
        ...
        for(i=1; i<=n; i++){   // Ciclo for para los renglones 
            for(j=1;j<=i;j++){ // Ciclo for para los numeros 
                System.out.print(j+" ");  // Imprimir los numeros 
            }
