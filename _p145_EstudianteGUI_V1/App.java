...
public class App extends JFrame implements ActionListener {
    ...
    public App() {
        ...
        pnlTabla.add(spane);
        table = new JTable();
        table.getTableHeader().setBackground(new Color(243, 214, 141));
        table.getTableHeader().setForeground(new Color(209,37,115));
        ...
        pnlDatos.setLayout(new GridLayout(4, 1, 78, 0));
